                ...
                <A.SignWrap>
                    <div>
                        <A.SignInputWrap>
                            ...
                            <A.SignInput type="text" placeholder="이름을 입력하세요." {...register("name")}/>
                        </A.SignInputWrap>
                    ...
                    <div>
                        <A.SignInputWrap>
                            ...
                            <A.SignInput  type="text" placeholder="이메일을 입력하세요." {...register("email")} />
                        </A.SignInputWrap>
                    ...
                    <div>
                        <A.SignInputWrap>
                            ...
                            <A.SignInput type="password" placeholder="비밀번호를 입력하세요." {...register("password")} />
                        </A.SignInputWrap>
                        <A.SignErrorBox>{formState.errors.password?.message}</A.SignErrorBox>
                    </div>

                    <div>
                        <A.SignInputWrap>
                            <A.SignSpan>비밀번호 확인:</A.SignSpan>
                            <A.SignInput type="password" placeholder="비밀번호를 입력하세요." {...register("pwCheck")} />
                        </A.SignInputWrap>
